...
const Index = ({ resdata, api }) => {
    ...
    const total_carat_now = lot_list.reduce((totalLot, allCarat) => totalLot + Math.round(allCarat.carat * 100) / 100, 0) || 0;
    const total_amount_now = lot_list.reduce((totalLot, allAmount) => totalLot + Math.round(allAmount.amount * 100) / 100, 0) || 0;
    ...
    let final_amount_now = total_amount_now + Math.round(difference.add_difference * 100) / 100 - Math.round(difference.minus_difference * 100) / 100 || 0;
